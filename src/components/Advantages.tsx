...
{ title: "Честные цены", desc: "Прозрачные сметы без скрытых платежей" },
{
  title: "Гарантия",
  desc: "Гарантийные обязательства на работы и установку"
}];
  ...
  return (
    <section className="py-12 md:py-16" data-oid="lu1no8.">
      <div className="container-safe" data-oid="be:k_ty">
        <div className="grid gap-4 md:grid-cols-4" data-oid="tcax0tj">
          {items.map((i) =>
